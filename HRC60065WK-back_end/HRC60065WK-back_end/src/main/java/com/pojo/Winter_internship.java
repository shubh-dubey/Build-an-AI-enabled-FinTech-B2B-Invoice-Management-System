...
public class Winter_internship {
	...
	public Winter_internship(int sl_no, String business_code, Integer cust_number, String clear_date,
			String buisness_year, String doc_id, String posting_date, String document_create_date,
